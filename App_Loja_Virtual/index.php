...
<body id="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-bottom: 1px solid whitesmoke;">
        ...
        <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
            <ul class="navbar-nav m-auto">
                <li class="nav-item">
                    <a class="nav-link text-info" id="p-home" href=""> Home </a>
                </li>
                <li class="nav-item">
    ...
    <!--Conteúdo-->
    <div class="text-success text-center mt-5" style="font-size: 40px;">Home</div>
    ...
    <div class="slide w-80">
        <figure class="container">
            ...
            <div id="slider">
                <a href="#" style="margin-left: 9%;" class="trs imgfluid"><img src="imagens/slideshow4.png" width="950" alt="Legenda da imagem 1" /></a>
    ...
    <hr>
    <div class="text-info text-center s-40" style="font-size: 40px;">Produtos Mais Recentes</div>
        ...
        foreach($exibir as $exibi){
            ...
            <div class="col-3 bloco_anuncio">
                ...
                <p style="width: 100%;" class="w-100">'.$exibi['nome'].'</p>
                    ...
                    <p id="preco" style="width: 100%;" class="w-100">R$'.$exibi['preco'].' reais</p>
    ...
    <div class="texto-rodape p-4 w-100 h-lg-10" style="border-top: 1px solid gray;">
